...
const ReleaseReadiness = () => {
  ...
  return (
    <Layout>
      <SectionWrapper>
        <motion.div {...fadeUp(0)}>
          <h1 className="text-3xl font-bold md:text-4xl">{t("release.heading")}</h1>
          <p className="mt-3 max-w-2xl text-muted-foreground">{t("release.subheading")}</p>
          <p className="mt-2 text-sm text-muted-foreground/70">{t("release.reach")}</p>
        </motion.div>

        {/* What We Track */}
        <div className="mt-10">
          <motion.h2 {...fadeUp(0)} className="mb-6 text-xl font-semibold">
        ...
        >
          <h3 className="text-lg font-semibold text-card-foreground">{t("release.governanceHeading")}</h3>
          <p className="mt-2 text-sm text-muted-foreground">{t("release.governanceBody")}</p>
        </motion.div>
      </SectionWrapper>
    </Layout>
  );
