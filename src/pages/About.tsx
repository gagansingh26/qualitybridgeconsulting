...
const content = {
  ...
  fr: {
    ...
    paragraph1: "L'expérience derrière QualityBridge couvre plus de 10 ans de livraison d'entreprise — avec des missions chez <strong>Johnson & Johnson</strong>, <strong>Workday</strong>, <strong>Alight</strong> et <strong>Aon</strong>, ainsi que des programmes dans les dispositifs médicaux, le luxe et les services financiers, dans des équipes en Amérique du Nord, en Allemagne et en Inde. Cette diversité permet d'entrer dans un programme complexe et de savoir à quoi ressemble la qualité.",
