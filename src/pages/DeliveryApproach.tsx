            ...
            <SectionWrapper className="relative overflow-hidden" style={{ backgroundImage: "radial-gradient(circle, rgba(59,130,246,0.05) 1px, transparent 1px)", backgroundSize: "20px 20px" }}>
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 md:gap-5">
                {digitalItems.map((item, i) => (
                  <motion.div key={i} {...fadeIn(i * 0.08)} className="rounded-lg border border-border bg-card p-4 card-shadow md:p-5">
          ...
          <motion.div key="sap" {...tabVariants}>
            <SectionWrapper className="relative overflow-hidden" style={{ backgroundImage: "radial-gradient(circle, rgba(59,130,246,0.05) 1px, transparent 1px)", backgroundSize: "20px 20px" }}>
              ...
              <div className="mt-6">
                ...
                {/* ── MOBILE: 3-col grid — NO scrollbar ── */}
                      ...
                      >
                        <span
                          className={`h-2 w-2 shrink-0 rounded-full ${
                            activePhase === i ? "bg-primary-foreground/60" : phaseColors[i]
                          }`}
                        />
                        {phase.name}
                      </button>
            ...
            <SectionWrapper className="bg-accent/50" style={{ backgroundImage: "radial-gradient(circle, rgba(59,130,246,0.04) 1px, transparent 1px)", backgroundSize: "20px 20px" }}>
              ...
              <div className="hidden md:block">
                ...
                <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
                  {uatPhases.map((phase, i) => (
                    <motion.div key={i} {...fadeIn(i * 0.06)} className="rounded-lg border border-border bg-card p-4 card-shadow">
            ...
            <SectionWrapper className="relative overflow-hidden" style={{ backgroundImage: "radial-gradient(circle, rgba(59,130,246,0.05) 1px, transparent 1px)", backgroundSize: "20px 20px" }}>
              ...
              <div className="grid grid-cols-2 gap-3 md:gap-4">
                {keyControls.map((c, i) => (
                  <motion.div key={i} {...fadeIn(i * 0.06)} className="flex items-center gap-3 rounded-lg border border-border bg-card p-3 card-shadow md:p-4">
            ...
            <SectionWrapper className="relative overflow-hidden" style={{ backgroundImage: "radial-gradient(circle, rgba(59,130,246,0.05) 1px, transparent 1px)", backgroundSize: "20px 20px" }}>
              ...
              <div className="grid grid-cols-2 gap-3 md:gap-5">
                {trackItems.map((item, i) => (
                  <motion.div key={i} {...fadeIn(i * 0.08)} className="rounded-lg border border-border bg-card p-3 card-shadow md:p-5">
                    <div className="flex items-center gap-2">
            ...
            <SectionWrapper className="bg-accent/50" style={{ backgroundImage: "radial-gradient(circle, rgba(59,130,246,0.04) 1px, transparent 1px)", backgroundSize: "20px 20px" }}>
              ...
              <div className="grid gap-3 sm:grid-cols-3 md:gap-4">
                {releaseStatuses.map((s, i) => (
                  <motion.div key={i} {...fadeIn(i * 0.1)} className="rounded-lg border border-border bg-card p-4 card-shadow md:p-5">
              ...
              <div className="mt-6">
                ...
                <div className="mt-4 grid grid-cols-2 gap-3 md:mt-6 md:gap-4">
                  {(t("delivery.automationItems", { returnObjects: true }) as string[]).map((label, i) => (
                    <motion.div key={i} {...fadeIn(i * 0.08)} className="flex items-center gap-2.5 rounded-lg border border-border bg-card p-3 card-shadow md:p-4">
                      <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-md bg-primary/10 text-primary md:h-10 md:w-10">
            ...
            <SectionWrapper className="relative overflow-hidden bg-accent/50" style={{ backgroundImage: "radial-gradient(circle, rgba(59,130,246,0.04) 1px, transparent 1px)", backgroundSize: "20px 20px" }}>
              ...
              <div className="mt-5 grid grid-cols-2 gap-3 md:mt-6 md:grid-cols-4 md:gap-4">
                {deliverables.map((d, i) => (
                  <motion.div key={i} {...fadeIn(i * 0.08)} className="flex flex-col items-center gap-2 rounded-lg border border-border bg-card p-3 text-center card-shadow md:flex-row md:gap-3 md:p-4 md:text-left">
