const fr = {
  ...
  about: {
    heading: "À propos",
    titlePrefix: "Engagé pour",
    titleAccent: "votre mise en production.",
    heroSubheading: "Gouvernance SAP, automatisation des tests et livraison digitale — structurées, prévisibles et à faible risque.",
    tags: ["Gouvernance SAP & UAT", "Automatisation des tests & Qualité", "Développement digital"],
    bio: [
      "Professionnel Technology Delivery & Quality Engineering avec 10+ ans d'expérience dans la construction de pratiques DevTestOps — tests automatisation-first, portes qualité CI/CD et observabilité — pour des releases prévisibles et à faible risque.",
      "Mon parcours couvre la livraison enterprise dans SaaS, ERP, assurance, HealthTech, FinTech et eCommerce — avec des plateformes comme Workday, SAP S/4HANA, Salesforce et Microsoft Dynamics 365. J'ai dirigé des programmes interrégionaux en Europe, Asie et Amérique du Nord, alignant les équipes produit, engineering et QA autour d'objectifs communs.",
      "Aujourd'hui, je me concentre sur l'application de l'IA générative et des LLMs pour améliorer la conception des tests, accélérer l'automatisation, détecter les risques tôt et soutenir une gouvernance des versions basée sur les métriques dans des équipes mondialement distribuées.",
    ],
    stats: [
      { value: "10+", label: "Ans d'expérience" },
      { value: "3 régions", label: "EU · Asie · Amériques" },
      { value: "6+", label: "Secteurs" },
      { value: "IA", label: "Conception de tests" },
    ],
    platformsLabel: "Plateformes & outils",
    whyHeading: "Pourquoi travailler avec nous",
    whySubheading: "Un engagement. Supervision locale. Capacité de livraison mondiale.",
    valueProps: [
      { title: "Expertise SAP approfondie", desc: "Expérience étendue sur les cycles d'implémentation et migration S/4HANA — gouvernance UAT, portes qualité et préparation au go-live." },
      { title: "Approche automatisation-first", desc: "Chaque engagement commence par une stratégie d'automatisation des tests — moins d'effort manuel et cycles de version accélérés dès le départ." },
      { title: "Supervision basée au Canada", desc: "Votre contact dédié gère le cadrage, la communication et la livraison depuis le GTA — avec des spécialistes mondiaux vérifiés derrière." },
      { title: "Qualité augmentée par l'IA", desc: "GenAI et LLMs appliqués à la conception des tests, détection des risques et analyse de couverture — tests plus intelligents avec moins de travail manuel." },
    ],
    ...
    ctaHeading: "Prêt à renforcer votre livraison ?",
    ctaBody: "Que vous planifiiez un programme SAP, développiez votre pratique QA ou construisiez un produit digital — parlons-en.",
