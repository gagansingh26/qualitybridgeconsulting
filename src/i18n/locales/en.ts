const en = {
  ...
  hero: {
    ...
    titlePrefix: "Structured delivery.",
    titleAccent: "No delivery chaos.",
    subtitle: "Development, SAP governance, and quality engineering — structured as one delivery system. Not three separate vendors. One accountable team.",
    reach: "Canada-based · Serving North America · Europe · Asia",
  ...
  problems: {
    ...
    subheading: "Three patterns we see repeatedly — across digital delivery, SAP programmes, and quality engineering.",
    sampleEngagement: "See real examples",
    items: [
      {
        pill: "Digital Development",
        title: "Platforms that ship late and break in production",
        desc: "No CI/CD from day one. No quality gates. Prototypes promoted directly to production. We build with structure — so what ships actually holds.",
      },
      {
        pill: "SAP Governance & UAT",
        title: "SAP go-lives decided on gut feel, not evidence",
        desc: "No structured UAT. No sign-off framework. Release decisions made under pressure. We replace instinct with defined quality gates and clear go/no-go criteria.",
      },
      {
        pill: "Quality Engineering",
        title: "Regression cycles too slow for modern release cadence",
        desc: "Manual testing can't keep up. Defects reach production. Releases slow down. We build automation-first QE that cuts cycles by 50–70% and gates every release with evidence.",
      },
    ],
  },
  cta: {
  ...
  differentiation: {
    ...
    heading: "We don't work in silos.",
    subheading: "Most programmes split development, SAP, and QA across separate vendors. We structure them as one delivery system — fewer handoffs, faster releases, no blame between teams.",
    items: [
      {
        title: "One delivery system — not three vendors",
