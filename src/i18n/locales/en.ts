const en = {
  ...
  hero: {
    ...
    statsStrip: [
      { value: "50–70%",    label: "faster delivery cycles across SAP, digital, and QA"          },
      { value: "3 pillars", label: "delivered as one governed system, not separate workstreams"   },
      { value: "1 team",    label: "accountable end-to-end — from kickoff to go-live"            },
    ],
  },
  capabilities: {
